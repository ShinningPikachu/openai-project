...
const base: Alarm = { id: "a", label: "Wake", hour: 7, minute: 30, enabled: true, repeatDays: [], vibrationEnabled: true, challengeType: "shape-photo", challengeDifficulty: "normal", targetShapeId: "circle", additionQuestionCount: 3, createdAt: "2026-01-01T00:00:00.000Z", updatedAt: "2026-01-01T00:00:00.000Z" };
